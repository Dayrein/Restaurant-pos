...
if (isset($_POST['make'])) {
    ...
    if (empty($_POST["order_code"]) || empty($_POST["customer_name"]) || empty($_POST['prod_price'])) {
        ...
        $prod_id = $_POST['prod_id']; // Changed to POST
        $prod_name = $_POST['prod_name']; // Changed to POST
        $prod_price = $_POST['prod_price']; // Changed to POST
        ...
        if (!$postStmt) {
            die("Database prepare failed: " . $mysqli->error);
        }
...
<body>
   <!-- Add JavaScript to handle customer selection -->
   <script>
  function getCustomer(customerName) {
      // AJAX call to get customer ID
      var xhr = new XMLHttpRequest();
      xhr.open('POST', 'get_customer_id.php', true);
      ...
      xhr.send('customer_name=' + encodeURIComponent(customerName));
  }
  </script>
    <!-- Sidenav -->
                            ...
                            <form method="POST" action="" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="order_code" value="<?php echo htmlspecialchars($alpha); ?>-<?php echo htmlspecialchars($beta); ?>" class="form-control">
                                    </div>
                                </div>
                                <hr>
                                <?php
                                ...
                                ?>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" readonly name="prod_price" value="<?php echo htmlspecialchars($prod->prod_price); ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <input type="hidden" name="prod_name" value="<?php echo htmlspecialchars($prod->prod_name); ?>
                                <br>
                                <div class="form-row">
                                    <div class="col-md-6">
